...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    GetRestaurantsResponse allRestaurantsCloseByOffPeakHours = new GetRestaurantsResponse(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(20.0, 30.2, LocalTime.of(3, 0), 5.0));
    GetRestaurantsResponse allRestaurantsCloseByPeakHours = new GetRestaurantsResponse(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(21.0, 31.1, LocalTime.of(19, 0), 3.0));
